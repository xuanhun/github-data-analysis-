...
Il progetto aggiorna l'implementazione dei grafici e introduce MongoDB per la cache dei dati, riducendo le chiamate all'API di GitHub e migliorando le prestazioni.
